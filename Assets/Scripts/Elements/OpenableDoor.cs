...
public class OpenableDoor : MonoBehaviour
{
    ...
    private MeshCollider meshColliderFrame;
    ...
    void Start()
    {
        ...
        GameObject bodyParent = transform.parent.gameObject;
        meshColliderFrame = bodyParent.GetComponent<MeshCollider>();
    }
    ...
    void Update()
    {
        ...
        //transform.Rotate(new Vector3(transform.localEulerAngles.x, Mathf.LerpAngle(currentRotationAngle, defaultRotationAngle + (open ? doorOpenAngle : 0), openTime), transform.localEulerAngles.z));
